...
describe "a class with simple method decorators" do
  class MyDecorator
    def initialize(klass, meth)
      puts "Initializing MyDecorator for #{klass}##{meth}"
      @meth = meth
    end
  ...
  class MyDecorator2
    def initialize(klass, meth)
      puts "Initializing MyDecorator2 for #{klass}##{meth}"
      @meth = meth
    end
  ...
  it "makes a new instance of the decorator when a decorated method is added" do
    ...
    end.should have_stdout "Initializing MyDecorator for Simple1#a_function\n"
  end
  ...
  it "initializes multiple decorators when a decorated method is added" do
    ...
    end.should have_stdout "Initializing MyDecorator for Simple2#a_function\n" \
                           "Initializing MyDecorator2 for Simple2#a_function\n"
  end
